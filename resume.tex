...
\newlength{\secskip}
\setlength{\secskip}{0.8\baselineskip}
...
% If enough space at the end, add the three goals of PCA -> p.187 notes
\paragraph{Fischer}
\[\max J(\vec{u}) = \frac{(m_1 - m_0)^2}{s_0^2 + s_1^2} = \frac{\vec{u}^T S_B \vec{u}}{\vec{u}^T S_W \vec{u}}\]
